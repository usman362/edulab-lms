...
<div class="mx-3 mt-16 sm:mt-24 lg:mt-[120px] relative z-[1]">
    <div class="bg-primary lg:bg-[url('{{ edulab_global_asset('lms/frontend/assets/images/counter/counter-bg.png') }}')] bg-no-repeat bg-cover max-w-[1600px] mx-auto py-[60px] rounded-[20px]">
        <div class="container">

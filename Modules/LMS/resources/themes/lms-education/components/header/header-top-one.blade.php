...
<!-- START TOP NOTIFY AREA -->
<div class="bg-primary py-3.5 hidden md:block">
    <div class="mx-[12px]">
        <div class="max-w-[1600px] mx-auto">
            <div class="flex-center-between">
                <div
                    class="flex items-center justify-start space-x-5 divide-x divide-white/15 [&>:not(:first-child)]:pl-5 grow">
                    ...
                    @if (isset($general['phone']))
                        <div class="flex items-center gap-2">
                            ...
                            <a href="tel:+{{ $general['phone'] }}" aria-label="Company phone"
                                class="text-sm !leading-none font-semibold text-white/80 hover:text-white custom-transition">{{ translate('Call') }}:
                                {{ $general['phone'] }}</a>
                        </div>
                    @endif

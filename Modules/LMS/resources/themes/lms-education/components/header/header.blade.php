...
@endphp
<header class="bg-white py-4 sticky-header">
    <div class="mx-[12px]">
        <div class="max-w-[1600px] mx-auto">
            <div class="flex-center-between">
                ...
                <div class="self-end flex items-center gap-3 shrink-0">
                    ...
                    @endif
                    <x-dynamic-component component='{{ "default:theme::header.right-side" }}' :theme="$theme" :data="$data" is-show-language="true" text-color="text-primary" />

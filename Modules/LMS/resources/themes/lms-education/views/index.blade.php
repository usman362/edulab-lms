@php
    $themeLogo = get_theme_option(key: 'theme_logo', theme_slug: 'lms-education') ?? get_theme_option(key: 'theme_logo') ?? [];
    ...
    $settings = [
        ...
        'cart' => [
            'is_show' => true,
            'url' => route('cart.page'),
            'icon_image' => edulab_global_asset('lms/frontend/assets/images/icons/cart.svg'),
            'badge_class' =>

@php
    ...
    $bannerPath = "lms/theme-options/{$bannerImageOne}";
    ...
    $bannerImage =
        !empty($bannerImageOne) && fileExists('lms/theme-options', $bannerImageOne) ? edulab_asset($bannerPath) : edulab_global_asset($defaultBanner);
@endphp

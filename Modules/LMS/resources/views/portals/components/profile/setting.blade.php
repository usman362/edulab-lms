@push('css')
    <link rel="stylesheet" href="{{ edulab_global_asset('lms/assets/css/vendor/tagmanager.css') }}" />
@endpush
<div class="card">
...
@push('js')
    <script src="{{ edulab_global_asset('lms/assets/js/vendor/tagmanager.min.js') }}"></script>
    <script src="{{ edulab_global_asset('lms/assets/js/vendor/bootstrap3-typeahead.js') }}"></script>
    <script src="{{ edulab_global_asset('lms/assets/js/component/stepper.js') }}"></script>
    <script src="{{ edulab_global_asset('lms/assets/js/component/profile.js') }}"></script>
@endpush

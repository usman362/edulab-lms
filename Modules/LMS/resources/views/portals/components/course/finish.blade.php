...
<div class="fieldset">
    <div
        ...
        <div class="flex flex-col items-center justify-center py-20 gap-6 text-center">
            <div>
                <img src="{{ edulab_global_asset('lms/assets/images/loti/loti-success-confirmation.svg') }}" alt="loti">
            </div>
            <div>
                ...
                <p class="font-spline_sans text-gray-900 my-4">
                    {{ translate('Your Course has been successfully created. Learn the best things in the world.') }}
                </p>
                <p class="font-spline_sans text-gray-900 my-4">

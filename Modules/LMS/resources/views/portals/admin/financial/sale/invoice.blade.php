@php
    ...
    $invoiceLogo =
        isset($backendLogo['invoice_logo']) && fileExists('lms/theme-options', $backendLogo['invoice_logo']) == true
            ? edulab_asset("lms/theme-options/{$backendLogo['invoice_logo']}")
            : edulab_global_asset('lms/assets/images/logo/logo.svg');
...
<head>
    ...
    <link rel="stylesheet" href="{{ edulab_global_asset('lms/assets/css/output.min.css') }}">
</head>

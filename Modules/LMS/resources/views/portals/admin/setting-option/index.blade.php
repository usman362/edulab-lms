<x-dashboard-layout>
    @push('css')
        <link rel="stylesheet" href="{{ edulab_global_asset('lms/assets/css/vendor/codemirror/codemirror.css') }}">
        <link rel="stylesheet" href="{{ edulab_global_asset('lms/assets/css/vendor/codemirror/theme/material-darker.css') }}">
        <link rel="stylesheet" href="{{ edulab_global_asset('lms/assets/css/vendor/codemirror/theme/material.css') }}">

        <script src="{{ edulab_global_asset('lms/assets/js/vendor/codemirror/codemirror.js') }}"></script>
        <script src="{{ edulab_global_asset('lms/assets/js/vendor/codemirror/javascript/javascript.js') }}"></script>
        <script src="{{ edulab_global_asset('lms/assets/js/vendor/codemirror/addon/hint/css-hint.js') }}"></script>
        <script src="{{ edulab_global_asset('lms/assets/js/vendor/codemirror/addon/hint/anyword-hint.js') }}"></script>
        <script src="{{ edulab_global_asset('lms/assets/js/vendor/codemirror/addon/comment/continuecomment.js') }}"></script>
        <script src="{{ edulab_global_asset('lms/assets/js/vendor/codemirror/addon/edit/matchbrackets.js') }}"></script>
        <script src="{{ edulab_global_asset('lms/assets/js/vendor/codemirror/addon/selection/active-line.js') }}"></script>
    @endpush
                        ...
                        <div class="col-span-full xl:col-auto leading-none">
                            ...
                            <label for="imgageTheme"
                                ...
                                <span class="flex-center flex-col peer-[.uploaded]/file:hidden">
                                    <img src="{{ edulab_global_asset('lms/assets/images/icons/upload-file.svg') }}" alt="file-icon"
                                        ...
                                        @if (isset($logo['logo']) && fileExists('lms/theme-options', $logo['logo']) == true && $logo['logo'] !== '')
                                            <div class="img-thumb-wrapper max-w-24 max-h-24"> <button
                                                ...
                                                <img id="preview_img" width="auto"
                                                    src="{{ edulab_asset('/lms/theme-options/' . $logo['logo']) }}" />
                                            </div>
                                        @else
                                            ...
                                            @if (isset($logo['favicon']) &&
                                                ...
                                                <div class="img-thumb-wrapper max-w-24 max-h-24 !size-10 flex-center">
                                                    ...
                                                    <img id="preview_img" width="16" height="16"
                                                        src="{{ edulab_asset('/lms/theme-options/' . $logo['favicon']) }}" />
                                                </div>
                                            @else
                                                <div class="img-thumb-wrapper max-w-24 max-h-24">
                                                    <button class="remove text-danger">
                                    ...
                                    <div class="box-body flex items-center gap-2 flex-wrap">
                                        @if (isset($logo['footer_logo']) &&
                                            ...
                                            <div class="img-thumb-wrapper max-w-24 max-h-24"> <button
                                                ...
                                                <img id="preview_img" width="auto"
                                                    src="{{ edulab_asset('/lms/theme-options/' . $logo['footer_logo']) }}" />
                                            </div>
                                        @else
                                            <div class="img-thumb-wrapper max-w-24 max-h-24">
                                                <button class="remove text-danger">
                                                ...
                                                @if (
                                                    ...
                                                    <div class="img-thumb-wrapper">
                                                        <img id="preview_img" width="120"
                                                            src="{{ edulab_asset('/lms/theme-options/' . $sliderImgDigital) }}" />
                                                    </div>
                                                @endif
                                        ...
                                        <div class="box box-solid">
                                            <div class="box-body flex items-center gap-2 flex-wrap">
                                                @if (
                                                    ...
                                                    <div class="img-thumb-wrapper">
                                                        <img id="preview_img" width="120"
                                                            src="{{ edulab_asset('/lms/theme-options/' . $sliderImgElearning) }}" />
                                                    </div>
                                                @endif
                                                <img id="preview_img" src="" width="120">
                                            </div>
                                        ...
                                        <div class="box box-solid">
                                            <div class="box-body flex items-center gap-2 flex-wrap">
                                                @if (
                                                    ...
                                                    <div class="img-thumb-wrapper">
                                                        <img id="preview_img" width="120"
                                                            src="{{ edulab_asset('/lms/theme-options/' . $sliderImgLms) }}" />
                                                    </div>
                                                @endif
                                                <img id="preview_img" src="" width="120">
                                            </div>
                                        ...
                                        <div class="box box-solid">
                                            <div class="box-body flex items-center gap-2 flex-wrap">
                                                @if (
                                                    ...
                                                    <div class="img-thumb-wrapper">
                                                        <img id="preview_img" width="120"
                                                            src="{{ edulab_asset('/lms/theme-options/' . $sliderImgKindergarten) }}" />
                                                    </div>
                                                @endif
                                                <img id="preview_img" src="" width="120">
                                            </div>

...
<x-dashboard-layout>
    ...
    <x-portal::admin.breadcrumb back-url="{{ route('instructor.bundle.index') }}" title="Edit" page-to="Bundle" />
    @if (is_active('instructor.bundle.translate') === 'active' && count(app('languages')) > 1)

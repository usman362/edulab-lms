        ...
        <div class="col-span-full 2xl:col-span-7 card p-0">
            <div class="grid grid-cols-12 px-5 sm:px-12 py-11 relative overflow-hidden h-full">
                ...
                <div class="col-span-full md:col-span-5 flex-col items-center justify-center 2xl:block hidden md:flex">
                    <img src="{{ edulab_global_asset('lms/assets/images/loti/loti-admin-dashboard.svg') }}" alt="online-workshop"
                ...
                <ul>
                    <li class="absolute -top-[30px] left-1/2 animate-spin-slow">
                        <img src="{{ edulab_global_asset('lms/assets/images/element/graphical-element-1.svg') }}" alt="element">
                    </li>
                    <li class="absolute -bottom-[24px] left-1/4 animate-spin-slow">
                        <img src="{{ edulab_global_asset('lms/assets/images/element/graphical-element-2.svg') }}" alt="element">
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="grid grid-cols-12 gap-4 h-full">
                <div class="col-span-full md:col-span-6 card p-5 mb-0">
                    <div
                        ...
                        <img src="{{ edulab_global_asset('lms/assets/images/icons/course-overview/progress.svg') }}" alt="icon"
                ...
                <div class="col-span-full md:col-span-6 card p-5 mb-0">
                    <div
                        class="size-11 flex-center bg-[#F7F3FF] dark:bg-dark-icon rounded-10 dk-theme-card-square mb-4">
                        <img src="{{ edulab_global_asset('lms/assets/images/icons/course-overview/complete.svg') }}" alt="icon"
                            class="dark:brightness-[5]">
                    </div>
                    <p class="text-gray-500 dark:text-dark-text font-medium leading-none mb-2">
                ...
                <div class="col-span-full md:col-span-6 card p-5 mb-0">
                    <div
                        class="size-11 flex-center bg-[#F7F3FF] dark:bg-dark-icon rounded-10 dk-theme-card-square mb-4">
                        <img src="{{ edulab_global_asset('lms/assets/images/icons/course-overview/purchase.svg') }}" alt="icon"
                            class="dark:brightness-[5]">
                    </div>
                    <p class="text-gray-500 dark:text-dark-text font-medium leading-none mb-2">
                ...
                <div class="col-span-full md:col-span-6 card p-5 mb-0">
                    <div
                        class="size-11 flex-center bg-[#F7F3FF] dark:bg-dark-icon rounded-10 dk-theme-card-square mb-4">
                        <img src="{{ edulab_global_asset('lms/assets/images/icons/course-overview/certificate.svg') }}"

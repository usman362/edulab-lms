    ...
    @php
        ...
        $coverPhoto =
            $userInfo->cover_photo && fileExists('lms/organizations', $userInfo->cover_photo) == true
                ? edulab_asset("lms/organizations/{$userInfo->cover_photo}")
        ...
        $profileImg =
            $userInfo?->profile_img && fileExists('lms/organizations', $userInfo?->profile_img) == true
                ? edulab_asset("lms/organizations/{$userInfo?->profile_img}")
                    ...
                    <div
                        ...
                        <div class="grow">
                            <h5
                                ...
                                {{ $name ?? $userInfo->name }}
                                @if ($user->is_verify)
                                    <img data-src="{{ edulab_global_asset('lms/frontend/assets/images/icons/verified.svg') }}"
                                        alt="Verified icon"

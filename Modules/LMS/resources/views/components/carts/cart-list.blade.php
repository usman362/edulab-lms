                        ...
                        <a href="{{ $route }}" class="size-20 rounded-50 overflow-hidden"
                            ...
                            @if (
                                $cartCourse['type'] == 'course' &&
                                    ...
                                    $cartCourse['image'] != '')
                                <img data-src="{{ edulab_asset('/lms/courses/thumbnails/' . $cartCourse['image']) }}"
                            ...
                            @elseif (
                                $cartCourse['type'] == 'bundle' &&
                                    ...
                                    $cartCourse['image'] != '')
                                <img data-src="{{ edulab_asset('/lms/courses/bundles/' . $cartCourse['image']) }}"
                                    alt="Course thumbnail" class="size-full object-cover">
                            @else
                                <img data-src="{{ edulab_global_asset('lms/frontend/assets/images/420x252.svg') }}"
                                    alt="Course thumbnail" class="size-full object-cover">
                            @endif
                        </a>
                        <div>

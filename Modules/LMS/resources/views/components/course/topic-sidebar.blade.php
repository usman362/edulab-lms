...
<div id="course-content-drawer"
    ...
    <div
        class="course-content-drawer-inner kh-course-sidebar bg-white fixed top-[theme('spacing.header')] left-0 rtl:left-auto rtl:right-0 bottom-0 -translate-x-full rtl:translate-x-full lg:translate-x-0 rtl:lg:translate-x-0 shrink-0 flex flex-col duration-500 border-r border-border rtl:border-r-0 rtl:border-l">
        {{-- SIDEBAR HEADER --}}
        <div class="px-5 py-4 border-b border-border flex-center-between shrink-0">
            <div class="min-w-0">
                <div class="text-[11px] uppercase tracking-wider text-heading/60 font-semibold">
                    {{ translate('Course') }}
                </div>
        ...
        @isset($courseProgress)
            <div class="px-5 py-3 border-t border-border shrink-0 bg-gray-50">
                <div class="flex-center-between text-xs text-heading/60 mb-1.5">

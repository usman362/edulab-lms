...
@php
    ...
    $img =
        $faqImg && fileExists('lms/theme-options', $faqImg) == true
            ? edulab_asset("lms/theme-options/{$faqImg}")
            : edulab_global_asset('lms/frontend/assets/images/faq/main-img.webp');
@endphp
<div class="relative overflow-hidden pt-60 sm:pb-130 pb-24">
    <div class="container grid sm:grid-cols-12 gap-10 items-center">
        <div class="lg:col-span-6 col-span-full relative">
            ...
            <!-- position item -->
            <img data-src="{{ edulab_global_asset('lms/frontend/assets/images/faq/element-left.webp') }}" alt="LMS-HUB"
            ...
            <div>
                <h1 class="section-heading xl:pr-64 sm:pr-44 pr-12 relative"> {{ $faq['title'] ?? '' }}
                    <span class="text-secondary"> {{ $faq['high_light'] ?? '' }}
                        <img data-src="{{ edulab_global_asset('lms/frontend/assets/images/icons/line.webp') }}" alt="line"
    ...
    <!-- position items -->
    <img data-src="{{ edulab_global_asset('lms/frontend/assets/images/faq/dot-elemt.webp') }}" alt="pattern"
        class="animate-shakeY absolute left-24 bottom-24 xl:block hidden">
    <img data-src="{{ edulab_global_asset('lms/frontend/assets/images/faq/union.webp') }}" alt="pattern"

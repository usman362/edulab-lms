...
<head>
    ...
    @if (!alreadyInstalled())
        @if (indexFile() == true)
            <!-- style css -->
            <link rel="stylesheet" href="{{ edulab_global_asset('installer/assets/css/style.css') }}">
        @else
            @if (env('ASSET_URL') !== null)
                <link rel="stylesheet" href="{{ edulab_global_asset('installer/assets/css/style.css') }}">
            @else
                <link rel="stylesheet" href="{{ edulab_global_asset('public/installer/assets/css/style.css') }}">
            @endif
...
<body>
    ...
    <script src="{{ edulab_global_asset($prefix . 'installer/assets/js/main.js') }}"></script>
